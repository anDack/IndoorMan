...
public class IndoorManWiki extends Fragment {
    ...
    private static String thisChannelUrl= ContentClass.INDOOR_WIKI_URL;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.indoor_wiki_zainanfulishe,container,false);
        mData=new ArrayList<>();
        initView(view);
        return view;
    }
