...
public class IndoorCatWelfare extends Fragment {
    ...
    private static String thisChannelUrl= ContentClass.CAT_WELARE_URL;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view=inflater.inflate(R.layout.cat_welfare_fragment,container,false);
        mData=new ArrayList<>();
